...
const playPieces = [
  {
    id: 1,
    shadow: "hsl(230, 89%, 55%)",
    ring: "linear-gradient(hsl(230, 89%, 62%), hsl(230, 89%, 65%))",
    icon:
      <svg width="49" height="59" aria-labelledby="paperIconSVGTitle">
        <title id="paperIconSVGTitle">Paper</title>
  ...
  },
  {
    id: 2,
    shadow: "hsl(40, 84%, 43%)",
    ring: "linear-gradient(hsl(39, 89%, 49%), hsl(40, 84%, 53%))",
    icon:
      <svg width="51" height="58" aria-labelledby="scissorsIconSVGTitle">
        <title id="scissorsIconSVGTitle">Scissors</title>
  ...
  {
    id: 3,
    shadow: "hsl(349, 70%, 46%)",
    ring: "linear-gradient(hsl(349, 71%, 52%), hsl(349, 70%, 56%))",
    icon:
      <svg width="48" height="48" aria-labelledby="rockIconSVGTitle">
        <title id="rockIconSVGTitle">Rock</title>
